...
const Index: React.FC<Props> = () => {
  ...
  return (
    <div className={styles.Index_root}>
      {hasProfile ? (
        <>
          <HeroBtnPages buttonName="企業情報" imageSrc="/HeroBtnPages/Charco Notifications.png" redirectPath="/profile_users" background = "radial-gradient(50% 50% at 50% 50%, rgba(39, 221, 233, 0.82) 0%, rgba(255, 255, 255, 0) 100%)" />
        ...
        <>
          <HeroBtnPages buttonName="企業情報作成" imageSrc="/HeroBtnPages/Charco Mobile Life.png" redirectPath="/profile_create_users" background="radial-gradient(50% 50% at 50% 50%, rgba(255, 74, 74, 0.71) 0%, rgba(236, 92, 92, 0) 100%)" />
