...
const Index: React.FC<Props> = () => {
  ...
  return (
    <div className={styles.Index_root}>
      {hasProfile ? (
        <>
          <HeroBtnPages buttonName="User Profile" imageSrc="/HeroBtnPages/Charco Send Email.png" redirectPath="/profile_users" background = "radial-gradient(50% 50% at 50% 50%, rgba(39, 221, 233, 0.82) 0%, rgba(255, 255, 255, 0) 100%)" />
